...
export const initializeDestinosViajesStates = () => ({
  items: [],
  loading: false,
  favorito: null
});
...
export function reducerDestinoViaje(
  ...
  switch (action.type) {
    case DestinosViajesActionTypes.NUEVO_DESTINO: {
      return {
        ...states,
        items: [...states.items, (action as NuevoDestinoAction).destino]
      };
    }
    case DestinosViajesActionTypes.ELEGIDO_FAVORITO: {
      states.items.forEach( x => x.setSelected(false));
